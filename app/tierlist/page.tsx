export const metadata = {
  title: "Tierlist Hentai | HentaiLA",
  description: "Las mejores tierlists de hentai creadas por la comunidad.",
};
      ...
      <section className="section top">
        <div className="top-header" style={{ textAlign: "center", padding: "4rem 1rem" }}>
          ...
          <p style={{ color: "var(--text)", fontSize: "1.2rem", maxWidth: "600px", margin: "0 auto" }}>
            Clasifica, comparte y descubre los mejores hentais ordenados por categorías.
          </p>
        </div>
      </section>
      ...
      <div className="columns" style={{ display: "flex", justifyContent: "center" }}>
        <main style={{ width: "100%", maxWidth: "800px" }}>
          <section className="section">
            ...
            >
              <i className="fa-list-ol" style={{ fontSize: "4rem", color: "var(--primary)", marginBottom: "1rem", display: "inline-block" }}></i>
              <h2 style={{ marginBottom: "1rem", color: "var(--title)" }}>En Construcción</h2>
              <p style={{ marginBottom: 0 }}>
                El creador de Tierlists se está preparando para su lanzamiento. ¡Vuelve pronto!
              </p>
            </div>
          </section>
        </main>
